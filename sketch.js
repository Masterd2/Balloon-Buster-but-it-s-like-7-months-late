...
var bow, bowImage;
var arrow, arrowImage, arrows;
var balloonSelect, balloonYSelect=100;
var score = 0;
...
function setup() 
{
  ...
  balloonB = createSprite(1000, balloonYSelect, 57, 57);
  balloonG = createSprite(1000, balloonYSelect, 57, 57);
  balloonR = createSprite(1000, balloonYSelect, 57, 57);
  balloonP = createSprite(1000, balloonYSelect, 57, 57);
} 
...
function draw() 
{
  ...
  if (arrows.isTouching(balloonB)||
  arrows.isTouching(balloonG)||
  arrows.isTouching(balloonR)||
  arrows.isTouching(balloonP)){
    score++;
  }
}
